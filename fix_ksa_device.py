"""
Fix KSA model .pt files to be device-agnostic
Removes CUDA device dependencies by re-saving with map_location
"""
import torch
from pathlib import Path

model_dir = Path("/Users/nourahmed/Desktop/GenArabia/ChatterBox REACT/models/ksa")

print("=" * 60)
print("Converting KSA Model Files to Device-Agnostic Format")
print("=" * 60)
